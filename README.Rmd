...
You can install the released version of rajiveutils from [CRAN](https://CRAN.R-project.org) with:
...
```{r heatmap, fig.alt="Heatmaps of raw data and RaJIVE joint, individual, and noise decomposition for all blocks"}
